...
#RYGAT_result_CHR10_nointergenic.txt


setwd("Z:/dep_coupland/grp_turck/carina/Tomato/GAT")
...
#m,"_GAT_Analysis.png"for _nointergenic.txt files Chr1-12
#m,"_GAT_Analysiswithintergenic.png") for m,"GAT_result_CHROM",c,".txt" CHr2-13
...
ggplot(GATresults, aes(Chromosome, annotation)) +
 ...
 # xlab=("chromosome")+ ylab=("annotation")+
